...
def plot_histograms():
    ...
    plt.hist(feature_list[0][0:50], bins=10, label=iris['target_names'][0],stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[0][50:100], bins=10, label=iris['target_names'][1],stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[0][100:150], bins=10, label=iris['target_names'][2],stacked=True, alpha=0.5,ec="k")
    plt.legend()
    ...
    plt.xlabel("Measurement [cm]")
    plt.ylabel("Number of samples in bin")
    plt.hist(feature_list[1][0:50], bins=10, label=iris['target_names'][0], stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[1][50:100], bins=10, label=iris['target_names'][1], stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[1][100:150], bins=10, label=iris['target_names'][2], stacked=True, alpha=0.5,ec="k")
    #plt.hist([feature_list[1][0:50],feature_list[1][50:100],feature_list[1][100:150]],bins=10, label=[iris['target_names'][0],iris['target_names'][1],iris['target_names'][2]])
    plt.legend()
    ...
    plt.xlabel("Measurement [cm]")
    plt.ylabel("Number of samples in bin")
    plt.hist(feature_list[2][0:50], bins=10, label=iris['target_names'][0],stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[2][50:100], bins=10, label=iris['target_names'][1], stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[2][100:150], bins=10, label=iris['target_names'][2], stacked=True, alpha=0.5,ec="k")
    plt.legend()
    ...
    plt.xlabel("Measurement [cm]")
    plt.ylabel("Number of samples in bin")
    plt.hist(feature_list[3][0:50], bins=10, label=iris['target_names'][0], stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[3][50:100], bins=10, label=iris['target_names'][1],stacked=True, alpha=0.5,ec="k")
    plt.hist(feature_list[3][100:150], bins=10, label=iris['target_names'][2],stacked=True, alpha=0.5,ec="k")
    plt.legend()
    plt.show()
...
#return_intersection(hist_s_0,hist_ve_0)
